                    ...
                    <div class="form-box">
                        ...
                        <div class="form-content">
                            ...
                            <div class="contact-form-action">
                                <form id="edit_admin" action="{{route('admin.update',$admin->id)}}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 responsive-column">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    <span class="la la-user form-icon"></span>
                                                    <input class="form-control" type="text" name="last_name" value="{{$admin->last_name}}" >
                                                    <span class="error_validate">
                                        ...
                                        <div class="col-lg-4 responsive-column">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" placeholder="EX: royeltravelagency@gmail.com" name="email" value="{{$admin->email}}" >
                                                    <span class="error_validate">
