<x-website.dashboard-master>
                ...
                <div class="col-lg-6">
                    <div class="breadcrumb-content">
                        <div class="section-heading">
                            <h2 class="sec__title font-size-30 text-white">إضافة سائق جديد</h2>
                        </div>
                    ...
                    <div class="form-box">
                        ...
                        <div class="form-content">
                            ...
                            <div class="contact-form-action">
                                <form id="create_driver" action="{{route('drivers.store')}}" method="POST">
                                    @csrf
                                    <div class="row">
    ...
    <script>
        ...
        $(function() {
            ...
            $('#create_driver').on('submit', function(e) {
                console.log('ali');
                e.preventDefault();
