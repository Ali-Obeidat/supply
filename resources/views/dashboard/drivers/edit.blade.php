<x-website.dashboard-master>
                ...
                <div class="col-lg-6">
                    <div class="breadcrumb-content">
                        <div class="section-heading">
                            <h2 class="sec__title font-size-30 text-white">تعديل بيانات الزبون</h2>
                        </div>
                    ...
                    <div class="form-box">
                        ...
                        <div class="form-content">
                            ...
                            <div class="contact-form-action">
                                <form id="edit_driver" action="{{route('drivers.update',$driver->id)}}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-lg-4 responsive-column">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="first_name" value="{{$driver->first_name}}" >
                                        ...
                                        <div class="col-lg-4 responsive-column">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    <span class="la la-user form-icon"></span>
                                                    <input class="form-control" type="text" name="last_name" value="{{$driver->last_name}}" >
                                                    <span class="error_validate">
                                        ...
                                        <div class="col-lg-4 responsive-column">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" placeholder="EX: royeltravelagency@gmail.com" name="email" value="{{$driver->email}}" >
                                                    <span class="error_validate">
                                         ...
                                         <div class="col-lg-6 responsive-column">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="number" name="phone" value="{{$driver->phone}}" >
                                                    <span class="error_validate">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="btn-box">
                                                <button class="theme-btn" type="submit">حفظ التعديلات</button>
                                            </div>
                                        </div><!-- end col-lg-12 -->
                                    </div><!-- end row -->
                                </form>
    ...
    <script>
        ...
        $(function() {
            ...
            $('#edit_driver').on('submit', function(e) {
                console.log('ali');
                e.preventDefault();
