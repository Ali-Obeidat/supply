                ...
                <div class="col-lg-6">
                    <div class="breadcrumb-content">
                        <div class="section-heading">
                            <h2 class="sec__title font-size-30 text-white">عرض جميع الزبائن</h2>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="table-content">
                                                    <h3 class="title">{{$customer->full_name}}</h3>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="table-content d-flex">
                                                    ...
                                                    <a href="{{route('customers.edit',$customer->id)}}" class="theme-btn theme-btn-small" data-toggle="tooltip" data-placement="top" title="" data-original-title="تعديل"><i class="la la-edit"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        @endforeach
