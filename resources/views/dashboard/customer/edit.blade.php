                    ...
                    <div class="form-box">
                        ...
                        <div class="form-content">
                            ...
                            <div class="contact-form-action">
                                <form id="edit_customer" action="{{route('customers.update',$customer->id)}}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 responsive-column">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" placeholder="EX: royeltravelagency@gmail.com" name="email" value="{{$customer->email}}" >
                                                    <span class="error_validate">
